<template>
    ...
    <div class="chapter-header">
      ...
      <div v-if="randomLandscapePhoto" class="random-landscape-photo-wrapper">
        <img :src="randomLandscapePhoto.url" :alt="randomLandscapePhoto.name || 'photo paysage'" class="random-landscape-photo" />
      </div>
      ...
      <div v-if="photos.length">
        <div class="photo-list">
          <div v-for="photo in photos" :key="photo.id" class="photo-wrapper">
            <img :src="photo.url" :alt="photo.name || 'photo'" class="chapter-photo" @click="openPhotoModal(photo)" style="cursor:pointer;" />
    ...
    <transition name="modal-fade">
      <div v-if="showPhotoModal" class="modal-overlay" @click.self="closePhotoModal">
        <div class="modal-content">
          <img :src="selectedPhoto?.url" :alt="selectedPhoto?.name || 'photo agrandie'" class="modal-photo" @load="onModalImgLoad" />
